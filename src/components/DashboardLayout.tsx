...
// Icons for project modules
const FrontOfficeIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
const NoDueIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
const GatePassIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
const BiometricIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
// Additional icons for gym staff navigation
...
const projectModules: ProjectModule[] = [
  {
    id: 'front-office',
    name: 'Front Office',
    description: 'Manage inquiries, admissions, and visitors',
  ...
  },
  {
    id: 'social',
    name: 'Social Feed',
    description: 'Connect with campus community and share updates',
    icon: SocialIcon,
  ...
  },
  {
    id: 'ticket',
    name: 'Ticket',
    description: 'Track and resolve support tickets and requests',
    icon: TicketIcon,
  ...
  },
  {
    id: 'gym',
    name: 'Gym',
    description: 'Manage gym schedules, posts, and equipment',
    icon: GymIcon,
  ...
  },
  {
    id: 'no-due',
    name: 'No Due',
    description: 'Manage and verify student clearance certificates',
    icon: NoDueIcon,
    href: '/dashboard/no-due',
    color: 'bg-green-500',
  },
  {
    id: 'attendance',
    name: 'Attendance',
    description: 'Track student and staff attendance records',
    icon: AttendanceIcon,
  ...
  },
  {
    id: 'biometric',
    name: 'Biometric',
    description: 'Manage biometric attendance and access control',
    icon: BiometricIcon,
...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  // Custom navigation items for gym staff
  ...
  // Custom navigation items for executive director
  ...
  if (roleName === 'gym_staff') {
    navItems = gymStaffNavigation;
  } else if (roleName === 'executive_director') {
    navItems = executiveDirectorNavigation;
  }
...
// Export project modules for use in other components
