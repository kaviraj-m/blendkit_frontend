...
export default function WardenComplaintsPage() {
  ...
  const fetchHostelComplaints = async () => {
    setLoading(true);
    try {
      // We need to add this method to complaintsApi
      const response = await complaintsApi.getHostelComplaints(token);
      ...
      toast.error('Failed to load hostel complaints');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <>
      <div className="mb-6">
        ...
        <p className="text-gray-600">Review and respond to student complaints from your hostel</p>
      </div>
            ...
            <div className="bg-white rounded-lg shadow">
              <div className="p-6 border-b">
                ...
                <div className="mb-4">
                  ...
                  <p className="text-sm text-gray-500">Accommodation: Hosteller</p>
                </div>
              </div>
